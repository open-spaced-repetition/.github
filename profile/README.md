...
- **Multiple Language Support**:
  ...
  - w/ optimization: [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs), [fsrs-rs-python](https://github.com/open-spaced-repetition/fsrs-rs-python), [fsrs-browser](https://github.com/open-spaced-repetition/fsrs-browser), [fsrs-rs-nodejs](https://github.com/open-spaced-repetition/fsrs-rs-nodejs), [fsrs-rs-dart](https://github.com/open-spaced-repetition/fsrs-rs-dart), [fsrs-rs-php](https://github.com/open-spaced-repetition/fsrs-rs-php), [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs)
